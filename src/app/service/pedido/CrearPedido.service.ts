...
export class CrearPedido {
  ...
  public async listincomeshistory(data: any): Promise<any> {
    ...
    try {
      ...
      var axiosResponse = await this.axiosClient.request({
        method: 'get',
        url: this.url + 'incomesPedidohistory',
        params: {
          id: data,
        },
      });
  ...
  public async getfindedititemincome(data: any): Promise<any> {
    ...
    try {
      ...
      var axiosResponse = await this.axiosClient.request({
        method: 'get',
        url: this.url + 'finditemsPedidoeditincome',
        params: {
          id: data,
        },
      });
  ...
  public async getfindpercentaje(data: any): Promise<any> {
    ...
    try {
      ...
      var axiosResponse = await this.axiosClient.request({
        method: 'get',
        url: this.url + 'findPedidopercentajename',
        params: {
          id: data,
        },
      });
  ...
  public async finditemincome(data: any): Promise<any> {
    ...
    try {
      ...
      var axiosResponse = await this.axiosClient.request({
        method: 'get',
        url: this.url + 'finditemsPedidoincome',
        params: {
          id: data,
        },
      });
  ...
  public async getdataincome(): Promise<any> {
    ...
    try {
      ...
      var axiosResponse = await this.axiosClient.request({
        method: 'get',
        url: this.url + 'incomesPedidovedata',
      });
      return axiosResponse.data;
    } catch (error) {
      return Promise.reject(this.normalizeError(error));
  ...
  public async getdatanewsupplier(): Promise<any> {
    ...
    try {
      ...
      var axiosResponse = await this.axiosClient.request({
        method: 'get',
        url: this.url + 'incomesPedidodatanewsupplier',
      });
      return axiosResponse.data;
    } catch (error) {
      return Promise.reject(this.normalizeError(error));
  ...
  public async saveincome(data: any): Promise<any> {
    ...
    try {
      ...
      var axiosResponse = await this.axiosClient.request({
        method: 'post',
        url: this.url + 'incomesPedidosave',
        data,
      });
      this.normalizeSuccess(axiosResponse);
      return axiosResponse.data;
  ...
  public async editincome(data: any): Promise<any> {
    ...
    try {
      ...
      var axiosResponse = await this.axiosClient.request({
        method: 'post',
        url: this.url + 'incomesPedidoedit',
        data,
      });
      this.normalizeSuccess(axiosResponse);
      return axiosResponse.data;
  ...
  public async listincomesstart(data: any): Promise<ListincomesIN> {
    try {
      ...
      var axiosResponse = await this.axiosClient.request({
        method: 'get',
        url: this.url + 'incomesPedidolistife',
        params: data,
      });
      // console.log(axiosResponse.data)
  ...
  public async listincomes(data: any): Promise<ListincomesIN> {
    try {
      ...
      var axiosResponse = await this.axiosClient.request({
        method: 'get',
        url: this.url + 'incomesPedidolistifefilter',
        params: data,
      });
      // console.log(axiosResponse.data)
  ...
  public async listincomesCSRS(data: any): Promise<ListincomesIN> {
    ...
    try {
      ...
      var axiosResponse = await this.axiosClient.request({
        method: 'get',
        url: this.url + 'incomesPedidolistCSRS',
        params: data,
      });
      // console.log(axiosResponse.data)
  ...
  public async listincomesCSRSPER(data: any): Promise<ListincomesIN> {
    ...
    try {
      ...
      var axiosResponse = await this.axiosClient.request({
        method: 'get',
        url: this.url + 'incomesPedidolistCSRSPER',
        params: data,
      });
      // console.log(axiosResponse.data)
  ...
  public async listincomesCSRSSALE(data: any): Promise<ListincomesIN> {
    ...
    try {
      ...
      var axiosResponse = await this.axiosClient.request({
        method: 'get',
        url: this.url + 'incomesPedidolistCSRSSALE',
        params: data,
      });
      // console.log(axiosResponse.data)
  ...
  public async savesuppliersincome(data: any): Promise<any> {
    ...
    try {
      ...
      var axiosResponse = await this.axiosClient.request({
        method: 'post',
        url: this.url + 'incomesPedidodatanewsuppliersave',
        data,
      });
      this.normalizeSuccess(axiosResponse);
      return axiosResponse.data;
  ...
  public async incomeapproved(data: any): Promise<any> {
    ...
    try {
      ...
      var axiosResponse = await this.axiosClient.request({
        method: 'get',
        url: this.url + 'incomesPedidoapproved',
        params: {
          id: data,
        },
      });
  ...
  public async incomedesapproved(data: any): Promise<any> {
    ...
    try {
      ...
      var axiosResponse = await this.axiosClient.request({
        method: 'get',
        url: this.url + 'incomesPedidodisapproved',
        params: {
          id: data,
        },
      });
  ...
  public async  ticketsincomes(data: any): Promise<any> {
    ...
    try {
      ...
      var axiosResponse = await this.axiosClient.request({
        method: 'post',
        url: this.url + 'tiketsPedidoincomes',
        data,
      });
      // this.normalizeSuccess(axiosResponse);
      return axiosResponse.data;
  ...
  public async findinventoryitem(data: any): Promise<any> {
    try {
      ...
      var axiosResponse = await this.axiosClient.request({
        method: 'post',
        url: this.url + 'findPedidoinventoryitems',
        data,
      });
      // this.normalizeSuccess(axiosResponse);
      return axiosResponse.data;
