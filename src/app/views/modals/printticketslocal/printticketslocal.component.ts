  ...
  async onSubmit() {
    ...
    if (this.printform.valid) {
     ...
     console.log(data)
      ...
      const url = `http://192.168.10.250:5000/api/printtikets?${params.toString()}`;//`http://localhost:5000/api/printtikets?${params.toString()}`; //`https://9bc8-186-69-248-234.ngrok-free.app/api/printtikets?${params.toString()}`;//
