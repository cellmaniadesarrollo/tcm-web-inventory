...
@Component({
  selector: 'app-incomesales',
  templateUrl: './incomesales.component.html',
  styleUrls: ['./incomesales.component.css']
})
export class IncomesalesComponent {
constructor(
  ...
  async listItems(form: any) {
    ...
    const data = await this.api.listincomesCSRSSALE(form);
