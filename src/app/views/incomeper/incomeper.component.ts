...
@Component({
  selector: 'app-incomeper',
  templateUrl: './incomeper.component.html',
  styleUrls: ['./incomeper.component.css']
})
export class IncomeperComponent {
 constructor(
  ...
  async listItems(form: any) {
    ...
    const data = await this.api.listincomesCSRSPER(form);
